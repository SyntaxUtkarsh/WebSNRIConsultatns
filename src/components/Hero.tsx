...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 pt-20 flex items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-block bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">
                Trusted by 5000+ NRIs Worldwide
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Trusted Consultation for
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600"> NRIs</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Your one-stop solution for all your India-based investments and transactions. 
                Financial consulting, due diligence, investment advisory, and real estate services.
              </p>
            </div>
